        ...
        <header className='header-top-strip py-3'>
          <div className="container-xxl">
            <div className="row">
              ...
              <div className="col-6">
                <p  className='text-white text-end mb-0'>Hotline: <a className='text-white' href= "tel : =91 9876543120">91 0987654321</a></p>
              </div>
            </div>
          </div>
        </header>
        <header className="header-upper py-3" >
          <div className="container xxl">
            <div className="row align-items-center">
              <div className="col-2">
                <h2>
                  <Link to={''} className='text-white'>DevCorner</Link>
                </h2>
              </div>
              <div className="col-5">
